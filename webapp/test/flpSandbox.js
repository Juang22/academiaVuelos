		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Vuelos",
									"targetURL": "#academiavuelos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"academiavuelos-display": {
								"semanticObject": "academiavuelos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=academia.vuelos",
									"url": sap.ui.require.toUrl("academia/vuelos")
								}
							}
						}
					}
